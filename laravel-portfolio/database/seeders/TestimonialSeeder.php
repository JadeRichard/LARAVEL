...
class TestimonialSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('testimonials')->insert([
            ...
            "icon"=>"img/testimonials/testimonials-1.jpg",
            "name"=>"Saul Goodman",
            "role"=>"Ceo & Founder",
        ]);
        DB::table('testimonials')->insert([
            "text"=>"Export tempor illum tamen malis malis eram quae irure esse labore quem cillum quid cillum eram malis quorum velit fore eram velit sunt aliqua noster fugiat irure amet legam anim culpa.",
            "icon"=>"img/testimonials/testimonials-2.jpg",
            "name"=>"Sara Wilsson",
            "role"=>"Designer",
        ]);
        DB::table('testimonials')->insert([
            "text"=>"Enim nisi quem export duis labore cillum quae magna enim sint quorum nulla quem veniam duis minim tempor labore quem eram duis noster aute amet eram fore quis sint minim.",
            "icon"=>"img/testimonials/testimonials-3.jpg",
            "name"=>"Jena Karlis",
            "role"=>"Store Owner",
        ]);
        DB::table('testimonials')->insert([
            ...
            "icon"=>"img/testimonials/testimonials-4.jpg",
            "name"=>"Matt Brandon",
            "role"=>"Freelancer",
        ]);
        DB::table('testimonials')->insert([
            ...
            "icon"=>"img/testimonials/testimonials-5.jpg",
            "name"=>"John Larson",
            "role"=>"Entrepreneur",
        ]);
    }
